...
describe('potsService', () => {
  describe('list', () => {
    it('returns all pots', async () => {
      const pots = [makePot()];
      mockGetState.mockReturnValue({ pots });
  ...
  describe('create', () => {
    ...
    it('returns error for duplicate name (case-insensitive)', async () => {
      mockGetState.mockReturnValue({ pots: [makePot({ name: 'Holiday' })] });
  ...
  describe('deposit', () => {
    it('returns updated pot and debit amount', async () => {
      mockGetState.mockReturnValue({ balance: 500, pots: [makePot({ balance: 100 })] });
    ...
    it('returns error for zero amount', async () => {
      mockGetState.mockReturnValue({ balance: 500, pots: [makePot()] });
    ...
    it('returns error when balance is insufficient', async () => {
      mockGetState.mockReturnValue({ balance: 30, pots: [makePot()] });
    ...
    it('returns error when pot not found', async () => {
      mockGetState.mockReturnValue({ balance: 500, pots: [] });
  ...
  describe('withdraw', () => {
    it('returns updated pot and credit amount', async () => {
      mockGetState.mockReturnValue({ pots: [makePot({ balance: 100 })] });
    ...
    it('returns error for negative amount', async () => {
      mockGetState.mockReturnValue({ pots: [makePot()] });
    ...
    it('returns error when pot balance is insufficient', async () => {
      mockGetState.mockReturnValue({ pots: [makePot({ balance: 20 })] });
  ...
  describe('remove', () => {
    it('returns the pot balance as refund amount', async () => {
      mockGetState.mockReturnValue({ pots: [makePot({ balance: 75 })] });
    ...
    it('returns zero refund for empty pot', async () => {
      mockGetState.mockReturnValue({ pots: [makePot({ balance: 0 })] });

...
Total topics: 9 | Total sources: 67
...
| [wallet-core](topics/wallet-core.md) | wallet, balance, transactions, db, walletStore, history, pagination, money, roundMoney, precision | 9 | 2026-06-11 | active |
| [pots](topics/pots.md) | savings pots, pots, deposit, withdraw, PotList, PotCard, amount validation | 7 | 2026-06-11 | active |
...
| [transport-layer](topics/transport-layer.md) | transport, mock, http, ApiTransport, ApiResponse, services, isValidAmount, NaN | 8 | 2026-06-11 | active |
...
| [testing](topics/testing.md) | tests, jest, RNTL, mocking, coverage, component tests, walletStore tests, money tests | 19 | 2026-06-11 | active |

## Concepts

| Concept | Connects | Last Updated |
|---------|----------|-------------|
| [money-integrity](concepts/money-integrity.md) | wallet-core, pots, transport-layer, voucher-shop, loyalty-rewards | 2026-06-11 |

## Recent Changes
- 2026-06-11: New `src/utils/money.ts` (roundMoney, isValidAmount, parseMoneyInput) — NaN/precision hardening across `wallet-core`, `transport-layer`, `pots`; `testing` updated (182 tests / 21 suites, new money.test.ts, PotList 15 tests, walletStore 14 tests); first concept article `money-integrity` created
